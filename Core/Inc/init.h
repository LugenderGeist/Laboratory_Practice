...
#define RCC_GPIO_ENF (*(uint32_t *)(0x40023800 + 0x30)|= 0x20)   //тактирование для шины AHB1, для всех GPIO
#define RCC_GPIO_ENB (*(uint32_t *)(0x40023800 + 0x30)|= 0x02)
...
#define GPIOC_READ1 (*(uint32_t *)(0x40020400 + 0x10) & 0x400) //F12
#define GPIOC_READ2 (*(uint32_t *)(0x40020400 + 0x10) & 0x800) //F13
